...
<b>commend : </b><code class="highlighter-rouge">wget https://www.python.org/ftp/python/3.6.5/Python-3.6.5.tgz</code>
...
<b>commend : </b><code class="highlighter-rouge">tar xvfz Python-3.6.5.tgz</code>
