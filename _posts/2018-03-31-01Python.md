...
<div class="well well-sm">
<b>Step 2. python 홈페이지에 링크된 파이썬 실행 파일을 window 시스템 버전으로 다운로드 후 실행한다.<a href = "https://www.python.org/downloads/release/python-365">파이썬 설치 페이지</a></b>
</div>
![_config.yml]({{ site.baseurl }}/images/2018-3-31-Python/python-installpage.png)
<br><br>
...
![_config.yml]({{ site.baseurl }}/images/2018-3-31-Python/python-tensorflowgpu.png)
<br>
