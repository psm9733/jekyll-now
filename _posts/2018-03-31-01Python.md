...
![_config.yml]({{ site.baseurl }}/images/2018-3-31-Python/window-python-tensorflowgpu.png)
<br>
<h2>리눅스</h2>
<b>cpu버전 commend : </b><code class="highlighter-rouge">pip3 install --upgrade tensorflow</code><br>
...
<br><br>
<b>gpu버전 commend : </b><code class="highlighter-rouge">pip3 install --upgrade tensorflow-gpu</code><br>
![_config.yml]({{ site.baseurl }}/images/2018-3-31-Python/linux-python-tensorflowgpu.png)
<hr><br>
