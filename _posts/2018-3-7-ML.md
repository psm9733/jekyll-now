...
<div class="well well-sm">
<b>Branching은 하나의 저장소에서 여러버전을 동시에 작업할때 사용하는 기능입니다.<br>

<b>저장소를 생성하면 초기에 Master라는 이름의 Branch만들 갖게 됩니다. 저장소에 새로운 파일을<br>

<b>추가하거나 수정 및 변경하고 저장(Commit)하게 되면 Commit한 내용이 Master 브랜치에<br>
