...
<div class="well">
<ol>
  <li><a href = "#step1">저장소 생성 및 사용하기</a></li>
  <li><a href = "#step2">브런치 시작 및 관리하기</li>
  <li><a href = "#step3">파일 변경과 GitHub에 커밋으로 푸시하기</li>
  <li><a href = "#step4">Open a pull request</li>
  <li><a href = "#step5">Merge your Pull Request</li>
</ol>
</div>
